...
class MockChange extends React.Component {
  ...
  handleSelectedLine = (line) => {
    ...
    console.log(line)
    this.setState({
      status: ['ready', 'ready', 'empty', 'empty'],
    ...
    return (
      <MainWrapper>
        ...
        <div>
          ...
          >
            <DialogTitle id="confirmation-dialog-title">Update access for employees</DialogTitle>
            <DialogContent>

              This access removal will impact this user's reportees. They will lose the similar access if they had one. Proceed with caution!
            </DialogContent>
            <DialogActions>
              <Button
